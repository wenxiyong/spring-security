...
!function ($) {
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if(typeof(configjson) != "undefined"&&configjson['code']=='order_search'){
            var toolbarHeight1 = getRealHeight(this.$toolbar),
                paginationHeight1 = getRealHeight(this.$pagination),
                height = this.options.height - toolbarHeight - paginationHeight;
            this.$tableContainer.css('height',document.body.clientHeight-toolbarHeight1-paginationHeight1-100+'px');
        }
